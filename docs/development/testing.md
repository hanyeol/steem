...
This document provides a comprehensive guide to testing in the Steem blockchain codebase, including unit tests, fixtures, test utilities, and code coverage analysis.

## Overview

The Steem test suite uses the [Boost.Test](https://www.boost.org/doc/libs/1_74_0/libs/test/doc/html/index.html) framework and is organized into two main test executables:
...
**Important**: The `BUILD_STEEM_TESTNET=ON` flag is **required** for building tests. Without it, the test executables will fail to build.

### Build Targets

**File**: [tests/CMakeLists.txt](../../tests/CMakeLists.txt)

- `chain_test` - Built from all `.cpp` files in `tests/tests/`
- `plugin_test` - Built from all `.cpp` files in `tests/plugin_tests/`
- `db_fixture` - Shared test fixture library
...
**File locations**: [tests/tests/](../../tests/tests/)

| Test Suite | File | Description |
|------------|------|-------------|
| `basic_tests` | [basic_tests.cpp](../../tests/tests/basic_tests.cpp) | Basic functionality tests (name validation, parsing, merkle trees) |
| `block_tests` | [block_tests.cpp](../../tests/tests/block_tests.cpp) | Blockchain and block validation tests |
| `live_tests` | [live_tests.cpp](../../tests/tests/live_tests.cpp) | Tests on live chain data (hardfork testing) |
| `operation_tests` | [operation_tests.cpp](../../tests/tests/operation_tests.cpp) | Unit tests for Steem operations |
| `operation_time_tests` | [operation_time_tests.cpp](../../tests/tests/operation_time_tests.cpp) | Time-based operation tests (e.g., vesting withdrawals) |
| `serialization_tests` | [serialization_tests.cpp](../../tests/tests/serialization_tests.cpp) | Serialization and deserialization tests |
| `undo_tests` | [undo_tests.cpp](../../tests/tests/undo_tests.cpp) | Database undo/redo functionality tests |
| `bmic_tests` | [bmic_tests.cpp](../../tests/tests/bmic_tests.cpp) | BMIC (Block Metadata Index Cache) tests |

### plugin_test Suites

**File locations**: [tests/plugin_tests/](../../tests/plugin_tests/)

- Market History Plugin Tests
- JSON-RPC Plugin Tests
- Account History Plugin Tests
- SMT Market History Tests (when SMT enabled)

## Test Fixtures

Test fixtures provide a controlled database environment for tests. All fixtures are defined in [tests/db_fixture/database_fixture.hpp](../../tests/db_fixture/database_fixture.hpp).

### clean_database_fixture

The most commonly used fixture. Creates a fresh blockchain database for each test.

**File**: [tests/db_fixture/database_fixture.cpp](../../tests/db_fixture/database_fixture.cpp#L37)
...
**File**: [tests/db_fixture/database_fixture.cpp](../../tests/db_fixture/database_fixture.cpp#L153)
...
**File**: [tests/db_fixture/database_fixture.hpp](../../tests/db_fixture/database_fixture.hpp#L335-351)
...
**Defined in**: [database_fixture.hpp](../../tests/db_fixture/database_fixture.hpp#L117-135)
...
**Defined in**: [database_fixture.hpp](../../tests/db_fixture/database_fixture.hpp#L140)
...
**Defined in**: [database_fixture.hpp](../../tests/db_fixture/database_fixture.hpp#L33-96)
...
**Defined in**: [database_fixture.hpp](../../tests/db_fixture/database_fixture.hpp#L154-179)

## Database Fixture Helper Functions

The `database_fixture` class provides many helper functions for test setup.

**File**: [tests/db_fixture/database_fixture.hpp](../../tests/db_fixture/database_fixture.hpp#L185-274)
...
├── db_fixture/                    # Test fixtures and utilities
...
│   ├── basic_tests.cpp           # Basic functionality tests
│   ├── block_tests.cpp           # Block validation tests
│   ├── operation_tests.cpp       # Operation unit tests
│   ├── operation_time_tests.cpp  # Time-based operation tests
│   ├── serialization_tests.cpp   # Serialization tests
│   ├── undo_tests.cpp            # Undo/redo tests
│   ├── live_tests.cpp            # Live blockchain tests
│   ├── smt_tests.cpp             # SMT tests (if enabled)
│   └── smt_operation_tests.cpp   # SMT operation tests (if enabled)
└── plugin_tests/                  # Plugin-specific tests
    ├── main.cpp                   # Plugin test runner
    ├── market_history.cpp         # Market history plugin tests
    └── json_rpc.cpp              # JSON-RPC plugin tests
```

## Related Documentation

- [Create Operation Guide](create-operation.md) - How to add new operations
- [Plugin Development Guide](plugin.md) - Plugin development guide
