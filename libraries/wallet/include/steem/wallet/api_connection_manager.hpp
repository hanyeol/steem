...
public:
   ...
   fc::api<database_api> database_api()
   {
      ...
      {
         try {
            _database_api = _api_connection->get_remote_api<database_api>( 0, "database_api" );
   ...
   fc::api<network_broadcast_api> network_broadcast_api()
   {
      ...
      {
         try {
            _network_broadcast_api = _api_connection->get_remote_api<network_broadcast_api>( 0, "network_broadcast_api" );
         } catch( const fc::exception& e ) {
   ...
   fc::api<account_by_key_api> account_by_key_api()
   {
      ...
      {
         try {
            _account_by_key_api = _api_connection->get_remote_api<account_by_key_api>( 0, "account_by_key_api" );
         } catch( const fc::exception& e ) {
   ...
   fc::optional<fc::api<block_api>> block_api()
   {
      ...
      {
         try {
            _block_api = _api_connection->get_remote_api<block_api>( 0, "block_api" );
         } catch( const fc::exception& e ) {
   ...
   fc::optional<fc::api<account_history_api>> account_history_api()
   {
      ...
      {
         try {
            _account_history_api = _api_connection->get_remote_api<account_history_api>( 0, "account_history_api" );
         } catch( const fc::exception& e ) {
   ...
   fc::optional<fc::api<follow_api>> follow_api()
   {
      ...
      {
         try {
            _follow_api = _api_connection->get_remote_api<follow_api>( 0, "follow_api" );
         } catch( const fc::exception& e ) {
   ...
   fc::optional<fc::api<market_history_api>> market_history_api()
   {
      ...
      {
         try {
            _market_history_api = _api_connection->get_remote_api<market_history_api>( 0, "market_history_api" );
         } catch( const fc::exception& e ) {
   ...
   fc::optional<fc::api<tags_api>> tags_api()
   {
      ...
      {
         try {
            _tags_api = _api_connection->get_remote_api<tags_api>( 0, "tags_api" );
         } catch( const fc::exception& e ) {
