...
// Import commonly used types from plugins
using database_api::api_account_object;
using database_api::api_witness_object;
using database_api::api_feed_history_object;
using database_api::api_limit_order_object;
using database_api::api_convert_request_object;
using database_api::api_dynamic_global_property_object;
using database_api::api_withdraw_vesting_route_object;
using database_api::api_owner_authority_history_object;
using account_history::api_operation_object;
using market_history::get_order_book_return;
...
class wallet_api
{
   public:
       ...
       */
      api_dynamic_global_property_object get_dynamic_global_properties() const;
       ...
       */
      signed_transaction get_transaction( transaction_id_type trx_id )const;
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction create_account_with_keys(
         string creator,
         string newname,
         string json_meta,
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction update_account(
         string accountname,
         string json_meta,
         public_key_type owner,
         public_key_type active,
       ...
       * @param broadcast true if you wish to broadcast the transaction.
       */
      signed_transaction update_account_auth_key(
         string account_name,
         authority_type type,
         public_key_type key,
         weight_type weight,
       ...
       * @param broadcast true if you wish to broadcast the transaction.
       */
      signed_transaction update_account_auth_account(
         string account_name,
         authority_type type,
         string auth_account,
         weight_type weight,
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction update_account_auth_threshold(
         string account_name,
         authority_type type,
         uint32_t threshold,
         bool broadcast );
       ...
       */
      signed_transaction update_account_meta(
         string account_name,
         string json_meta,
         bool broadcast );
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction update_account_memo_key(
         string account_name,
         public_key_type key,
         bool broadcast );
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
       signed_transaction delegate_vesting_shares(
          string delegator,
          string delegatee,
       ...
       * @param broadcast true if you wish to broadcast the transaction.
       */
      signed_transaction update_witness(
         string witness_name,
         string url,
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction transfer_to_vesting(
         string from,
         string to,
         asset amount,
         bool broadcast = false);
       ...
       */
      signed_transaction transfer_to_savings(
         string from,
         string to,
         asset amount,
         string memo,
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction transfer_from_savings(
         string from,
         uint32_t request_id,
         string to,
         asset amount,
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction cancel_transfer_from_savings(
       ...
       * @param broadcast true if you wish to broadcast the transaction.
       */
      signed_transaction set_withdraw_vesting_route(
         string from,
         string to,
         uint16_t percent,
         bool auto_vest,
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction convert_sbd(
         string from,
         asset amount,
         bool broadcast = false );
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction publish_feed(
         string witness,
         price exchange_rate,
         bool broadcast );
       ...
       */
      get_order_book_return get_order_book( uint32_t limit = 1000 );
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction create_order(
         string owner,
         uint32_t order_id,
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction cancel_order(
         string owner,
         uint32_t orderid,
         bool broadcast );
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction post_comment(
         string author,
         string permlink,
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction request_account_recovery(
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction recover_account(
         string account_to_recover,
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction change_recovery_account(
         string owner,
       ...
       */
      map< uint32_t, api_operation_object > get_account_history( string account, uint32_t from, uint32_t limit );
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      signed_transaction follow( string follower, string following, set<string> what, bool broadcast );
      ...
      signed_transaction decline_voting_rights( string account, bool decline, bool broadcast );
