...
FC_REFLECT( steem::wallet::broadcast_transaction_synchronous_return, (id)(block_num)(trx_num)(expired) )
FC_REFLECT( steem::wallet::scheduled_hardfork, (hf_version)(live_time) )
FC_REFLECT_ENUM( steem::wallet::withdraw_route_type, (incoming)(outgoing)(all) )
