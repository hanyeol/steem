...
struct comment_reward_context
{
   ...
   uint128_t  content_constant = STEEM_CONTENT_CONSTANT;
};
...
{
   return STEEM_CONTENT_CONSTANT; // looking good for posters
}

uint128_t evaluate_reward_curve( const uint128_t& rshares, const protocol::curve_id& curve = protocol::quadratic, const uint128_t& content_constant = STEEM_CONTENT_CONSTANT );
