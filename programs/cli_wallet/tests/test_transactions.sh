...
test_command "Account Creation" "create_account_with_keys \"creator\" \"newaccount2\" \"{}\" STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh false"
test_command "Account Creation" "create_account_delegated \"creator\" \"0.001 STEEM\" \"0.000000 VESTS\" \"newaccount3\" \"{}\" false"
test_command "Account Creation" "create_account_with_keys_delegated \"creator\" \"0.001 STEEM\" \"0.000000 VESTS\" \"newaccount4\" \"{}\" STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh false"

# 2. Account Update Commands
echo -e "\n${YELLOW}=== 2. ACCOUNT UPDATE COMMANDS ===${NC}"

test_command "Account Update" "update_account \"testaccount\" \"{}\" STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh false"
test_command "Account Update" "update_account_auth_key \"testaccount\" \"active\" STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh 1 false"
...
test_command "Account Update" "update_account_memo_key \"testaccount\" STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh false"

# 3. Witness Commands
echo -e "\n${YELLOW}=== 3. WITNESS TRANSACTION COMMANDS ===${NC}"

test_command "Witness" "update_witness \"witnessaccount\" \"http://witness.url\" STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh {\"account_creation_fee\":\"0.100 STEEM\",\"maximum_block_size\":131072,\"sbd_interest_rate\":1000} false"
test_command "Witness" "vote_for_witness \"voter\" \"witness\" true false"
test_command "Witness" "set_voting_proxy \"account\" \"proxy\" false"
test_command "Witness" "publish_feed \"witness\" {\"base\":\"1.000 SBD\",\"quote\":\"1.000 STEEM\"} false"

# 4. Transfer Commands
echo -e "\n${YELLOW}=== 4. TRANSFER COMMANDS ===${NC}"

test_command "Transfer" "transfer \"from\" \"to\" \"1.000 STEEM\" \"memo\" false"
test_command "Transfer" "transfer_to_vesting \"from\" \"to\" \"1.000 STEEM\" false"
...
test_command "Transfer" "transfer_to_savings \"from\" \"to\" \"1.000 STEEM\" \"memo\" false"
test_command "Transfer" "transfer_from_savings \"from\" 1 \"to\" \"1.000 STEEM\" \"memo\" false"
test_command "Transfer" "cancel_transfer_from_savings \"from\" 1 false"

# 5. Escrow Commands
echo -e "\n${YELLOW}=== 5. ESCROW COMMANDS ===${NC}"

test_command "Escrow" "escrow_transfer \"from\" \"to\" \"agent\" 1 \"1.000 SBD\" \"0.000 STEEM\" \"0.100 SBD\" \"2025-12-31T23:59:59\" \"2026-01-31T23:59:59\" \"{}\" false"
...
test_command "Escrow" "escrow_release \"from\" \"to\" \"agent\" \"from\" \"to\" 1 \"1.000 SBD\" \"0.000 STEEM\" false"

# 6. Market/Trading Commands
echo -e "\n${YELLOW}=== 6. MARKET/TRADING COMMANDS ===${NC}"

test_command "Market" "create_order \"owner\" 1 \"1.000 SBD\" \"1.000 STEEM\" false 3600 false"
test_command "Market" "cancel_order \"owner\" 1 false"
test_command "Market" "convert_sbd \"from\" \"1.000 SBD\" false"
...
test_command "Recovery" "request_account_recovery \"recovery_account\" \"account_to_recover\" {\"weight_threshold\":1,\"account_auths\":[],\"key_auths\":[[\"STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh\",1]]} false"
test_command "Recovery" "recover_account \"account_to_recover\" {\"weight_threshold\":1,\"account_auths\":[],\"key_auths\":[[\"STM5RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh\",1]]} {\"weight_threshold\":1,\"account_auths\":[],\"key_auths\":[[\"STM6RqVBAVNp5ufMCetQtvLGLJo7unX9nyCBMMrTXRWQ9i1Zzzizh\",1]]} false"
...
test_command "Other" "claim_reward_balance \"account\" \"0.000 STEEM\" \"0.000 SBD\" \"0.000000 VESTS\" false"
